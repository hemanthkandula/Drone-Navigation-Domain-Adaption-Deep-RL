...
def generate_json(cfg):
    ...
    if cfg.mode == 'move_around':
        ...
        if cfg.Target:
            ...
            _, reset_array_raw, _, _ = initial_positions2(cfg.env_name+"2", num_agents=cfg.num_agents)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--main_cfg',  type=str, default="configs/config.cfg", help='')
