...
class PedraAgent():
    def __init__(self, cfg, client, name, vehicle_name,Target=True, data_collect=False):
        ...
        ###########################################################################
        # if data_collect:
        #     network = importlib.import_module('network.network_models_data_collect')
        # else:
        network = importlib.import_module('network.network_models_en')

        # network = importlib.import_module('network.network_models_cu')
        net_mod = 'network.' + 'initialize_network_' + cfg.algorithm + '(cfg, name, vehicle_name,Target,data_collect)'
