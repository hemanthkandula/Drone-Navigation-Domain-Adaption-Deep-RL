...
def indoor_updown2():
    ...
    # level_name = ['UpDown1']
    crash_threshold = 0.07
    return phy_cords,orig_ip, level_name, crash_threshold
    # return orig_ip, level_name, crash_threshold

def initial_positions2(name, initZ=0, num_agents = 1):
    print("initial_positions2",name)
    name = name+'()'
    phy_cords,orig_ip, levels, crash_threshold = eval(name)
    ...
    for agents in range(num_agents):
        ...
        physical_player_start = phy_cords
        ...
        reset_array[name_agent] = reset_array[name_agent]
        reset_array_raw[name_agent] = reset_array_raw[name_agent]
        level_names[name_agent] = level_names[name_agent]
